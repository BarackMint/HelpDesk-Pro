<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-400 mt-0.5">Your assigned tickets and workload</p>
        </div>
    </x-slot>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg border border-gray-100">
            <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                <p class="text-sm font-medium text-gray-900">Recently Assigned</p>
                <a href="{{ route('tickets.index') }}"
            ...
            @if($recentTickets->isEmpty())
                <div class="px-5 py-8 text-center">
                    <p class="text-sm text-gray-400">No tickets assigned to you yet.</p>
                </div>
            @else
